...
<div class="container">
            <form class="form-horizontal" role="form" action="/user/saveuserdata" method="post">
                <h2>Registration</h2>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="password" id="password" name="repassword" placeholder="Password" class="form-control">
                    </div>
                </div>
                <div class="form-group">
